...
we need to present some brief definitions.
In transcriptional networks genes are represented by nodes. 
...
```{r full.network, echo=FALSE, fig.margin=TRUE}
...
plot.igraph(
  ...
  arrow.size = 0.01, edge.color = "grey", main = "E. coli transcriptional network"
)
plot.igraph(
  lac.graph, vertex.color = "blue", vertex.size = 10, vertex.label = NA,
  arrow.size = 0.01, edge.color = "grey", main = "Lac-* subset of E. coli's TN"
)
```
